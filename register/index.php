...
<!-- Header Images -->
  <div class="w3-display-container w3-center">
    <img src="/assets/images/Register.png" style="width:100%; height: 380px;" draggable="false">
        ...
        <form action="" method="post" name="signup">
          <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
            ...
            <div class="animated fadeInLeft" style="animation-delay: 0s;">
              <input class="w3-input w3-border" type="text" placeholder="Username" name="usernameReg" id="username" required="required">
          	</div>
            </div>
            <div class="w3-half">
            <div class="animated fadeInLeft" style="animation-delay: 0s;">
              <input class="w3-input w3-border" type="password" placeholder="Password" required name="passwordReg">
          	</div>
            </div>
          </div>
          	<div class="animated fadeInLeft" style="animation-delay: 0.1s;">
              <input class="w3-input w3-border" type="text" placeholder="Email" required name="emailReg">
          	</div>
          ...
          <div class="animated fadeInLeft" style="animation-delay: 0.3s;">
          	<input class="w3-button w3-black w3-section btn-lg btn-block" type="submit" name="signupSubmit" value="REGISTER">
