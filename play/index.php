...
$fechaexpira=strtotime($row['UpgradeExpire']);
$hoy=strtotime(date("Y-m-d H:i:s"));
$hoy2=date("Y-m-d H:i:s");
$diff=$fechaexpira-$hoy;
echo $u_id;
if($diff<0){
  $actualizar=$db->prepare("UPDATE meh_users SET UpgradeDays = -1, Access = 1 WHERE Access = 10 AND id = $u_id");
  $actualizar->execute();
}
}
?>
...
<div class="mt-3 mb-3">
    ...
    <div class="col-sm-6">
      <div class="w3-container">
        <div class="w3-red pt-2 pb-2 mt-1 mb-1">
          <h3 class="NavBar-Title text-center">Welcome <?php echo $username; ?></h3>
        </div>
      </div>
    </div>
    <div class="col-sm-3"></div>
  ...
  <center>
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="u35941" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="960" height="550">
        <param name="movie" value="../gamefiles/ALT_Loader2.1.swf" />
        ...
        <embed id="gameSWF" src="../gamefiles/ALT_Loader2.1.swf" width="960" height="550" loop="false" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" scale="exactfit" allowscriptaccess="always" allowFullScreen="true" menu="false" flashvars="&sLang=en">
      </embed>             
    </object>   
  </center>
</div>
