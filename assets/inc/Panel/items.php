...
<html>
  ...
  <body>
    ...
    <div>
      ...
      <div class="full">
        <div class="block-title">
        <h6 class="heading-hr"><i class="icon-file"></i> Search Item</h6>
                </ul>
                </div>
      ...
      if(!(isset($_POST['search-term']))){
        ...
        foreach ($resultado as $row) {
          ...
          echo "
            <tr>
              ...
              <td>$author</td>
              <td>
              <a href='add-item.php?edit=$id'><i class='fa fa-pencil-square-o text-info'></i></a>
        ...
        echo "</table>
        <center><a href='items.php' class='text-info'><br /><br />All items list</a></center>
        ";
      }
    ?>
                      </tbody>
