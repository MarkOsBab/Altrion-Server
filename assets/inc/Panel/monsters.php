  ...
  <body>
    ...
    <div>
          ...
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <button type="submit" class="btn btn-default"><i class="fa fa-search text-info"></i></button>
                ...
                <hr>
                <div class="title"><strong>Monsters</strong></div>
      ...
      if(!(isset($_POST['search-term']))){
        ...
        foreach ($resultado as $row) {
          ...
          echo "
            <tr>
              ...
              <td>$drops</td>
              <td>
              <a href='add-monster.php?edit=$id'><i class='fa fa-pencil-square-o text-info'></i></a>
              </td>
            </tr>
          ";
        }
        ...
        $busca_it = $db->prepare("SELECT * FROM meh_monsters WHERE ((`Name` LIKE '%".$busca_prot."%') OR ('%".$busca_prot."%'))");
        $busca_it ->execute();
