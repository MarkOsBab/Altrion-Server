...
<!-- Store Content Start -->
  <div class="w3-content w3-red pt-5 pb-5 text-center">
    <h3 class="NavBar-Title w3-text-black">Your purchase of <font class="w3-text-white"><?php echo $purchase; ?></font> was completed successfully!  <b><a class="button1 w3-hover-text-black w3-hover-yellow" style="text-decoration: none;" target="_blank" href="/play"><span>PLAY!</span></a></b></h3>
  </div>
<!-- Store Content End -->
